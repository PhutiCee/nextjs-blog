                    ...
                    <div className="flex flex-col items-center justify-between lg:flex-row py-16">
                        <div className=" relative ">
                            ...
                            <div className="lg:max-w-xl lg:pr-5 relative z-40">
                                ...
                                <h2 className="mb-6 max-w-lg text-5xl font-light leading-snug tracking-tight text-g1 sm:text-7xl sm:leading-snug">
                                    We make you learn
                                    <span className="my-1 inline-block border-b-8 border-g4 bg-white px-3 font-bold text-g4 animate__animated animate__flash">different</span>
                                </h2>
                                <p className="text-base text-gray-700">At <b>Blog<span className='text-blue-600'>IT</span></b>, we are dedicated to empowering individuals like you by providing exceptional articles that transcend conventional learning. Our commitment to excellence is reflected in every piece we curate, ensuring that your journey of acquiring knowledge and honing your skills is both enlightening and purposeful.</p>
                                ...
                                <div className="mt-10 flex flex-col items-center md:flex-row">
                                    <Link href="/" className="mb-3 inline-flex h-12 w-full items-center justify-center rounded bg-green-600 px-6 font-medium tracking-wide text-white shadow-md transition hover:bg-blue-800 focus:outline-none md:mr-4 md:mb-0 md:w-auto">
                                        View More</Link>
                                    <Link href="www.youtube.com/@tpsekwadi6463" aria-label="" className="group inline-flex items-center font-semibold text-g1">Watch how
                                        it works
                        ...
                        <div className="relative hidden lg:ml-32 lg:block lg:w-1/2">
                            ...
                            <div className="abg-orange-400 mx-auto w-fit overflow-hidden rounded-[6rem] rounded-br-none rounded-tl-none">
                                <img src="https://placehold.co/400x400?text=Blog+IT" />
                            </div>
                        </div>
                    </div>
                </div>
