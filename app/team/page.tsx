...
export const metadata: Metadata = {
    title: "Our Team",
    description: "Explore the top collection of BlogIT team behind the building of this website"
}
        ...
        <section className="bg-white min-h-screen">
            <div className="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6 ">
                <div className="mx-auto max-w-screen-sm text-center mb-8 lg:mb-16">
                    ...
                    <p className="font-light text-gray-500 lg:mb-16 sm:text-xl ">Explore the top collection of BlogIT team behind the building of this website</p>
                </div>
                <div className="grid gap-8 mb-6 lg:mb-16 md:grid-cols-2">
                    <div className="items-center bg-gray-50 rounded-lg border border-gray-300 shadow-lg sm:flex ">
                        ...
                        <div className="p-5">
                            ...
                            <ul className="flex space-x-4 sm:mt-0">
                                <li>
                                    <Link href="https://www.facebook.com/profile.php?id=61550308065075&sfnsn=scwspwa&mibextid=RUbZ1f" className="text-gray-500 hover:text-gray-900 ">
                                ...
                                <li>
                                    <Link href="https://twitter.com/SenpaiInTech" className="text-gray-500 hover:text-gray-900">
                                        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true"><path d="M8.29 20.251c7.547 0 11.675-6.253 11.675-11.675 0-.178 0-.355-.012-.53A8.348 8.348 0 0022 5.92a8.19 8.19 0 01-2.357.646 4.118 4.118 0 001.804-2.27 8.224 8.224 0 01-2.605.996 4.107 4.107 0 00-6.993 3.743 11.65 11.65 0 01-8.457-4.287 4.106 4.106 0 001.27 5.477A4.072 4.072 0 012.8 9.713v.052a4.105 4.105 0 003.292 4.022 4.095 4.095 0 01-1.853.07 4.108 4.108 0 003.834 2.85A8.233 8.233 0 012 18.407a11.616 11.616 0 006.29 1.84" /></svg>
                                    </Link>
                                </li>
                                <li>
                                    <Link href="https://github.com/PhutiCee" className="text-gray-500 hover:text-gray-900 ">
